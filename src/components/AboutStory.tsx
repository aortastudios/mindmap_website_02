...
const AboutStory = () => {
  return (
    <section className="my-10">
      <Container>
        <div className="w-full h-176 lg:h-111.75 flex flex-col lg:flex-row gap-4 lg:gap-6 justify-between my-3">
          ...
          <div className="flex-1   h-full text-primary-100">
            <h1 className="text-[24px] font-bold md:text-[52px] ">
              Our Story so far
            </h1>
            ...
            <p className="leading-6 md:leading-8.25 md:text-[22px]  text-[14px] mt-4">
