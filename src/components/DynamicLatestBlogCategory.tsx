...
const DynamicLatestBlogCategory = ({ articles }: Props) => {
    ...
    <div className="w-full h-full mb-10">
      <Container>
        <div className="w-full h-full">
          <h1 className=" font-bold lg:font-semibold text-[18px] lg:text-[26px] text-primary-100 mb-5 capitalize">
...
export default DynamicLatestBlogCategory;
