...
const LatestRecoveryArticle = () => {
  return (
    <div className="w-full h-full  mb-10">
      <Container>
        <div className="w-full h-full">
          <h1 className=" font-bold lg:font-semibold text-[24px] lg:text-[26px] text-primary-100 pt-10 lg:pt-0 mb-5">
            Latest Rest and Recovery articles
          </h1>
          <div className="w-full h-full lg:h-108  flex flex-col lg:flex-row gap-6">
            <div className=" h-full flex-1 ">
              <div className="upper-div h-50 lg:h-[50%] w-full  rounded-[20px] relative">
                <Image src={"/images/wellness.png"} alt="Wellness_image" fill className="" />
              </div>
...
export default LatestRecoveryArticle;
