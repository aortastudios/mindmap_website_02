    ...
    <section className=" max-w-360 h-full  mx-auto  lg:mt-15 pt-45 lg:pt-0 ">
      <Container>
        ...
        <div className="w-full h-full hidden lg:block">
          <div className=" w-full h-130 lg:h-125  backdrop-blur-sm  lg:rounded-[70px] flex flex-col items-center justify-center border  border-white/10   overflow-hidden relative">
      ...
      <div className="absolute  left-0 w-full bottom-1 h-0 lg:h-[5%] bg-transparent backdrop-blur-md "></div>
